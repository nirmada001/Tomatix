...
<head>
    ...
    <link rel="stylesheet" href="../Assests/css/Quitgame.css?v=<?php echo time(); ?>">
     <!-- Font Awesome CSS -->
            ...
            <center>
                <div class="level">
                    ...
                    <div class="level-content">
                        <h2 class="welcome"><?php echo $username; ?>! Sure need to log out?</h2><br>

                        <div class="level-button">
                            <div class="button">
                               <button class="btn btn-primary"><a href="Logout.php">Logout</a></button> <br><br>
                            </div>
